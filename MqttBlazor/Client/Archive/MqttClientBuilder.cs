...
{
    public static async Task CleanDisconnect()
    {
        /*
    ...
    public static async Task ConnectClientTimeout()
    {
        /*
    ...
    public static async Task ConnectClientUsingMQTTv5()
    {
        /*
    ...
    public static async Task ConnectClientUsingWebSockets()
    {
        /*
         * This sample creates a simple MQTT client and connects to a public broker using a WebSocket connection.
         * 
    ...
    public static async Task DisconnectNonClean()
    {
        /*
    ...
    public static async Task InspectCertificateValidationErrors()
    {
        /*
    ...
    public static async Task ReconnectUsingEvent()
    {
        /*
    ...
    public static void ReconnectUsingTimer()
    {
        /*
         * This sample shows how to reconnect when the connection was dropped.
